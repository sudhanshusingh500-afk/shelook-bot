...
# --- CONFIGURATION ---
# The API Key will be set in the Render Dashboard later
GOOGLE_API_KEY = os.environ.get("GOOGLE_API_KEY")

if GOOGLE_API_KEY:
    genai.configure(api_key=GOOGLE_API_KEY)

# --- THE BRAIN (Updated Policies) ---
SYSTEM_INSTRUCTION = """
...
- Keep answers short (2-3 sentences) unless the user asks for details.
- If you don't know the answer, say: "I'm not sure, please contact our team at +91-74392-28282."
"""
...
def get_ai_response(user_message):
    try:
        ...
        return f"I apologize, I am having trouble connecting right now. Error: {str(e)}"
